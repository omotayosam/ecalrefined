...
<div class="w3l_banner_nav_right">
	...
	<div class="agileinfo_single">
		...
		<div class="col-md-4 agileinfo_single_left">
			<img id="example" src="<?php echo $item['pic']; ?>" alt=" " class="img-responsive"/>
		</div>
		<div class="col-md-8 agileinfo_single_right">
			...
			<div class="snipcart-item block">
				<div class="snipcart-thumb agileinfo_single_right_snipcart">
					<h4><?php echo $item['currency'] . $item['discount_price'] ?><span><?php echo $item['currency'] . $item['m_price'] ?></span></h4>
				</div>
				<div class="snipcart-details agileinfo_single_right_details">
					<form action="#" method="post">
						<fieldset>
							...
							<input type="hidden" name="amount" value="<?php echo $item['cart_price'] ?>"/>
							<input type="hidden" name="discount_amount" value="<?php echo $item['cart_discounted'] ?>"/>
